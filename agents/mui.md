...
- [Range bar](/x/react-charts/range-bar.md): Range bar charts highlight the range between minimum and maximum values across categories. (premium) 🆕
...
- [Brush](/x/react-charts/brush.md): Let users select a region on a chart by clicking and dragging.
- [Custom components](/x/react-charts/components.md): Create custom chart components using the provided hooks.
- [Composition](/x/react-charts/composition.md): Learn how to use composition to build advanced custom Charts.
- [Export](/x/react-charts/export.md): Let users export a chart as an image or in PDF format. (pro)
- [Highlighting](/x/react-charts/highlighting.md): Highlight data points and series to provide quick visual feedback.
- [Label](/x/react-charts/label.md): Customize how series and data points are labeled in charts.
- [Legend](/x/react-charts/legend.md): Legend is the UI element mapping symbols and colors to the series' label.
- [Localization](/x/react-charts/localization.md): Adapt charts to different languages and locales.
- [Stacking](/x/react-charts/stacking.md): Display the decomposition of values by stacking series on top of each other.
...
- [BarChartPremium](/x/api/charts/bar-chart-premium.md): API documentation for BarChartPremium (premium)
...
- [ChartContainerPremium](/x/api/charts/chart-container-premium.md): API documentation for ChartContainerPremium (premium)
...
- [ChartDataProviderPremium](/x/api/charts/chart-data-provider-premium.md): API documentation for ChartDataProviderPremium (premium)
...
- [FocusedFunnelSection](/x/api/charts/focused-funnel-section.md): API documentation for FocusedFunnelSection (pro)
- [FocusedHeatmapCell](/x/api/charts/focused-heatmap-cell.md): API documentation for FocusedHeatmapCell (pro)
- [FocusedRadarMark](/x/api/charts/focused-radar-mark.md): API documentation for FocusedRadarMark
- [FocusedSankeyLink](/x/api/charts/focused-sankey-link.md): API documentation for FocusedSankeyLink (pro)
- [FocusedSankeyNode](/x/api/charts/focused-sankey-node.md): API documentation for FocusedSankeyNode (pro)
...
- [RangeBarPlot](/x/api/charts/range-bar-plot.md): API documentation for RangeBarPlot (premium)
- [SankeyChart](/x/api/charts/sankey-chart.md): API documentation for SankeyChart (pro)
- [SankeyDataProvider](/x/api/charts/sankey-data-provider.md): API documentation for SankeyDataProvider (pro)
...
- [Undo and redo](/x/react-data-grid/undo-redo.md): Let users undo and reapply changes made to the Data Grid. (premium) 🆕
